...
namespace WebStore.TagHelpers
{
    ...
    public class ActiveRouteTagHelper : TagHelper
    {
        ...
        [HtmlAttributeName("asp-all-route-data", DictionaryAttributePrefix =
            "asp-route-")]
        ...
        /// <remarks>Must be <c>null</c> if
        ///  <see cref="P:Microsoft.AspNetCore.Mvc.TagHelpers.AnchorTagHelper.Route" />
        ///  is non-<c>null</c>.</remarks>
        [HtmlAttributeName("asp-controller")]
        public string Controller { get; set; }

        /// <summary>
        /// Gets or sets the 
        /// <see cref="T:Microsoft.AspNetCore.Mvc.Rendering.ViewContext" />
        ...
        {
            // Почему здесь мы не обращаемся к свойствам этого класса
